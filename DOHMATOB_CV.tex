...
Non-smooth convex optimization; preprocessing and statistical analysis of fMRI data; registration algorithms; machine learning on fMRI data.\newline{}}
...
\cvitem{Personal projects}{See complete on my github profile: \url{https://github.com/dohmatob}}

\section{Scientific Talks}
\cvitem{PRNI 2014}{For PRNI (Pattern Recoginition in Neuroimaging) conference that toke place
June 3rd -- June 6th 2014 at the Max-Planck Institute, Tuebingen -- Germany, I was invited to present my work,
  \emph{Extracting brain regions from rest fMRI with Total-Variation constrained dictionary learning}
...
\cvitem{BrainHack 2013}{With Alexandre Gramfort, I worked on Henson's multimodal (fMRI, MEG, DTI) faces vs objects dataset}
\cvitem{Google Hash Code Paris 2014}{In this competition, I teamed with 2 other members to implement an automatic street-viewer.
  The underlying problem can formulated as a multi-objective TSP. Our algorithm was a Monte-Carlo (random walks on the
  roadmap of Paris).}
